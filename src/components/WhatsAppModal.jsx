        ...
        <>
            <div className='modal'>
                <div className="modal-content">
                    ...
                    <a href={`https://api.whatsapp.com/send?phone=${import.meta.env.VITE_APP_WHATSAPP}`} target='_blank' className="modal-button whatsapp-btn"><FaWhatsapp className='whatsapp-icon' size={28}/>Open WhatsApp</a>
                </div>
            </div>
        </>
    )
